...
import 'package:example/post_provider.dart';
import 'package:example/widgets/post.dart';
...
class PickerCropResultScreen extends StatelessWidget {
  ...
  final Stream<InstaExportDetails> cropStream;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<InstaExportDetails>(
        stream: cropStream,
...
class CropResultView extends StatelessWidget {
  ...
  final InstaExportDetails? result;
  final double heightFiles;
  final double heightAssets;

  List<InstaExportData?> get data => result?.data ?? [];
